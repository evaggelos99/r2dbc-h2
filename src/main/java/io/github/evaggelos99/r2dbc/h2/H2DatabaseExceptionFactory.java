...
public final class H2DatabaseExceptionFactory {
	...
	/**
	 * Convert {@link DbException} to {@link SQLException} before converting to
	 * {@link R2dbcException}.
	 *
	 * @param dbException root cause to be translated.
	 * @return the translated {@link R2dbcException}.
	 */
	public static R2dbcException convert(final DbException dbException) {
		final SQLException e = DbException.toSQLException(dbException);
	...
	static class H2R2dbcDataException extends R2dbcException {
		...
		H2R2dbcDataException(final String message, final String sqlState, final int errorCode, final SQLException e) {
	...
	static class H2R2dbcException extends R2dbcException {
		...
		H2R2dbcException(final String message, final String sqlState, final int errorCode, final SQLException e) {
			super(message, sqlState, errorCode, e);
		}
	}
	...
	static class H2R2dbcNonTransientException extends R2dbcNonTransientException {
		...
		H2R2dbcNonTransientException(final String message, final String sqlState, final int errorCode,
	...
	static class H2R2dbcTransientException extends R2dbcTransientException {
		...
		H2R2dbcTransientException(final String message, final String sqlState, final int errorCode,
				final SQLException e) {
			super(message, sqlState, errorCode, e);
		}
	}
	...
	static class H2R2dbcNonTransientResourceException extends R2dbcNonTransientResourceException {
		...
		public H2R2dbcNonTransientResourceException(final String reason) {
			super(reason);
		}
	}
