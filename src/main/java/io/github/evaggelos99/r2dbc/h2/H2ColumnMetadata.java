...
public final class H2ColumnMetadata implements ColumnMetadata {
	...
	H2ColumnMetadata(Codecs codecs, String name, TypeInfo typeInfo, Nullability nullability, Long precision,
			Integer scale) {
		...
		this.type = new H2Type(Assert.requireNonNull(typeInfo, "typeInfo must not be null"),
				codecs.preferredType(typeInfo.getValueType()));
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(this.codecs, that.codecs) && this.name.equals(that.name) && this.type.equals(that.type)
				&& this.nullability == that.nullability && this.precision.equals(that.precision)
	...
	public String toString() {
		return "H2ColumnMetadata{" + "codecs=" + this.codecs + ", name='" + this.name + '\'' + ", type=" + this.type
				+ ", nullability=" + this.nullability + ", precision=" + this.precision + ", scale=" + this.scale + '}';
	}
