...
public final class MockCodecs implements Codecs {
	...
	private MockCodecs(Map<Decoding, Object> decodings, Map<Object, Value> encodings,
			Map<Integer, Class<?>> preferredTypes) {
	...
	public <T> T decode(Value value, int dataType, Class<? extends T> type) {
		...
		if (!this.decodings.containsKey(decoding)) {
			throw new AssertionError(
					String.format("Unexpected call to decode(value,int,Class<?>) with values '%s, %d, %s'", value,
	...
	public String toString() {
		return "MockCodecs{" + "decodings=" + this.decodings + ", encodings=" + this.encodings + ", preferredTypes="
				+ this.preferredTypes + '}';
	}
	...
	public static final class Builder {
		...
		@Override
		public String toString() {
			return "Builder{" + "decodings=" + this.decodings + ", encodings=" + this.encodings + ", preferredTypes="
					+ this.preferredTypes + '}';
		}
	}
	...
	private static final class Decoding {
		...
		public boolean equals(Object o) {
			...
			return this.dataType == decoding.dataType && Objects.equals(this.value, decoding.value)
		...
		@Override
		public String toString() {
			return "Decoding{" + "value=" + this.value + ", dataType=" + this.dataType + ", type=" + this.type + '}';
		}
	}
}